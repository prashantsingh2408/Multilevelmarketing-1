                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-8">
                                        <div class="page-header-title">
                                            <h5 class="m-b-10">Auto Pool Income</h5>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <ul class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item">Income Report</li>
                                            <li class="breadcrumb-item"><a href="#">Auto Pool Income</a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-sm-9">
                                                                <input type="text" class="form-control" required
                                                                    placeholder="Track ID" style="border-radius:3px;">
                                                            </div>
                                                        </div>
                                                        <div class="form-group row">
                                                            <div class="col-xl-8 co-md-12 col-sm-12">
                                                                <div class="form-group row">
                                                                    ...
                                                                    <div class="col-sm-4">
                                                                        <input type="date" class="form-control" required
                                                                            placeholder="To" style="border-radius:3px;">
                                                                    </div>
                                                                </div>
                                                            </div>
