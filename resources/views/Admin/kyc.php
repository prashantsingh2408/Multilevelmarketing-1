                          ...
                          <div class="card table-card">
                            ...
                            <div class="card-block">
                              ...
                              <div class="form-group row d-flex flex-row-reverse">
                                ...
                                <div class="table-responsive-xl details" style="padding:0 10px;display:none;">
                                    <table class="table table-responsive table-bordered" rules="all" id="ContentPlaceHolder1_grd" style="width:100%;border-collapse:collapse;" cellspacing="0" cellpadding="4" border="1">
                                        <tbody>
                                            ...
                                            <th scope="col" style="color:White;background-color:#000000;font-family:verdana;font-size:12px;" align="left">Pan Number</th>
                                            <th scope="col" style="color:White;background-color:#000000;font-family:verdana;font-size:12px;" align="left">Photo</th>
                                            <th scope="col" style="color:White;background-color:#000000;font-family:verdana;font-size:12px;" align="left">Pan</th>
                                            <th scope="col" style="color:White;background-color:#000000;font-family:verdana;font-size:12px;" align="left">Aadhar</th>
                                            <th scope="col" style="color:White;background-color:#000000;font-family:verdana;font-size:12px;" align="left">Cheque</th>
                                            <th scope="col" style="color:White;background-color:#000000;font-family:verdana;font-size:12px;" align="left">Remark</th>
                                            </tr>
