                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-8">
                                        <div class="page-header-title">
                                            <h5 class="m-b-10">TDS/Maintenance</h5>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <ul class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item"><a href="#">TDS/Maintenance</a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                            ...
                                            <div class="col-xl-12 col-md-12">
                                                <div class="card table-card">
                                                    ...
                                                    <div class="card-block">
                                                        <form action="{{url ('Admin/tds')}}" method="post">
                                                            @csrf
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-10">
                                                                    <input name="tds" type="text" class="form-control"
                                                                        required placeholder="Enter The TDS"
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-10">
                                                                    <input name="maintenance" type="text"
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-10">
                                                                    <select name="with_pan" class="form-control"
                                                                        required>
                                                        ...
                                                        <div class="row" style="padding:10px;">
                                                            <table class="table table-hover table-bordered"
                                                                ...
                                                                <thead class="thead-dark">
                                                                    <tr>
                                                                        <th scope="col"><strong id="tabth">TDS</strong>
                                                                        </th>
                                                                        <th scope="col"><strong
                                                                                id="tabth">Maintenance</strong></th>
                                                                        <th scope="col"><strong id="tabth">PAN</strong>
                                                                        </th>
                                                                    </tr>
                                                                </thead>
                                                                <tbody>
