                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-6">
                                        <div class="page-header-title">
                                            <h5 class="m-b-10">Auto Pool Tree Views(Level 1)</h5>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <ul class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item"><a href="#">Auto Pool Tree Views(Level 1)</a>
                                            </li>s
                                        </ul>
                                    </div>
                                </div>
                                                    ...
                                                    <div class="card-block">
                                                        ...
                                                        <div class="form-group row">
                                                            <div class="col-xl-12 col-md-12 col-sm-12 d-flex flex-row-reverse">
                                                                <button class="btn waves-effect waves-light btn-success" style="border-radius:5px;margin:5px;"><i class="icofont icofont-check-circled"></i>Get
                                                                    Details</button>
                                                            </div>
                                                        </div>
                                                    </div>
