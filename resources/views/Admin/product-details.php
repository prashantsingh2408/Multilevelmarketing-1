                            ...
                            <div class="card-block">
                              <div class="form-group row">
                                <div class="col-xl-12 col-md-12 col-sm-12 d-flex flex-row-reverse">
                                  <button class="btn waves-effect waves-light btn-success" style="border-radius:5px;margin:5px;" data-toggle="modal" data-target="#ad-product">Add Product</button>
                                </div>
                              </div>
                                ...
                                <table class="table table-responsive table-bordered" rules="all" id="ContentPlaceHolder1_grd" style="width:100%;border-collapse:collapse;" cellspacing="0" cellpadding="4" border="1">
                                  <tbody>
                                    ...
                                    <tr style="color:#333333;background-color:#F7F6F3;border-color:#8B91A0;" align="center">
                                      ...
                                      <td style="font-size:14px;height:30px;" align="center">10</td>
                                      <td style="font-size:14px;height:30px;" align="center">
																				<svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="edit" class="svg-inline--fa fa-edit fa-w-18" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512" data-toggle="modal" data-target="#edit-product" style="cursor:pointer;width:30px;"><path fill="currentColor" d="M402.6 83.2l90.2 90.2c3.8 3.8 3.8 10 0 13.8L274.4 405.6l-92.8 10.3c-12.4 1.4-22.9-9.1-21.5-21.5l10.3-92.8L388.8 83.2c3.8-3.8 10-3.8 13.8 0zm162-22.9l-48.8-48.8c-15.2-15.2-39.9-15.2-55.2 0l-35.4 35.4c-3.8 3.8-3.8 10 0 13.8l90.2 90.2c3.8 3.8 10 3.8 13.8 0l35.4-35.4c15.2-15.3 15.2-40 0-55.2zM384 346.2V448H64V128h229.8c3.2 0 6.2-1.3 8.5-3.5l40-40c7.6-7.6 2.2-20.5-8.5-20.5H48C21.5 64 0 85.5 0 112v352c0 26.5 21.5 48 48 48h352c26.5 0 48-21.5 48-48V306.2c0-10.7-12.9-16-20.5-8.5l-40 40c-2.2 2.3-3.5 5.3-3.5 8.5z"></path></svg>
                              ...
                              <div class="form-group row">
                                <div class="col-xl-12 col-md-12 col-sm-12 d-flex flex-row-reverse">
                                  <button class="btn waves-effect waves-light btn-inverse" id="export" style="border-radius:5px;margin:5px;"><i class="fa fa-file-excel-o" aria-hidden="true"></i>Export TO Excel</button>
															...
															<!-- Modal -->
															<div class="modal fade" id="edit-product" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
																<div class="modal-dialog modal-dialog-centered" role="document">
																	<div class="modal-content">
																		...
																		<div class="modal-body">
																			<div class="form-group row">
																					<label class="col-sm-5 col-form-label"><h6>Enter Product Name:*</h6></label>
																					<div class="col-sm-7">
																							<input type="text" class="form-control" required placeholder="Product-Name" style="border-radius:3px;">
																					</div>
																			</div>
																			<div class="form-group row">
																					<label class="col-sm-5 col-form-label"><h6>Investment:*</h6></label>
																					<div class="col-sm-7">
																							<input type="number" class="form-control" required placeholder="Investment" style="border-radius:3px;">
																					</div>
																			</div>
																			<div class="form-group row">
																					<label class="col-sm-5 col-form-label"><h6>Processing Charge*</h6></label>
																					<div class="col-sm-7">
																							<input type="number" class="form-control" required placeholder="Processing Charge" style="border-radius:3px;">
																					</div>
																			</div>
																			<div class="form-group row">
																					<label class="col-sm-5 col-form-label"><h6>Enter Price*</h6></label>
																					<div class="col-sm-7">
																							<input type="number" class="form-control" required placeholder="Price" style="border-radius:3px;">
																					</div>
																			</div>
																			<div class="form-group row">
																					<label class="col-sm-5 col-form-label"><h6>Enter Point:*</h6></label>
																					<div class="col-sm-7">
																							<input type="number" class="form-control" required placeholder="Point" style="border-radius:3px;">
																					</div>
																			</div>
																			<div class="form-group row">
																					<label class="col-sm-5 col-form-label"><h6>Enter Sponsor Value:*</h6></label>
																					<div class="col-sm-7">
																							<input type="number" class="form-control" required placeholder="Sponsor Value" style="border-radius:3px;">
																					</div>
																			</div>
																			<div class="form-group row">
																					<label class="col-sm-5 col-form-label"><h6>Enter Bond Value:*</h6></label>
																					<div class="col-sm-7">
																							<input type="number" class="form-control" required placeholder="Bond Value" style="border-radius:3px;">
																					</div>
																			</div>
																			<div class="form-group row">
																					<label class="col-sm-5 col-form-label"><h6>Enter Maturity Time:*</h6></label>
																					<div class="col-sm-7">
																							<input type="number" class="form-control" required placeholder="Maturity Time" style="border-radius:3px;">
																					</div>
																			</div>
																		</div>
															...
															<!-- Modal -->
															<div class="modal fade" id="ad-product" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
																<div class="modal-dialog modal-dialog-centered" role="document">
																	<div class="modal-content">
																		<div class="modal-header">
