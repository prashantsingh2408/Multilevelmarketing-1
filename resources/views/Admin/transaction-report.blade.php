                                                ...
                                                <div class="card table-card">
                                                    ...
                                                    <div class="card-block">
																											<div class="form-group row">
																												<label class="col-sm-3 col-form-label"><h6>Track ID:*</h6></label>
																												<div class="col-sm-9">
																											...
																											<div class="form-group row">
																												<div class="col-xl-8 co-md-12 col-sm-12">
																													<div class="form-group row">
																														...
																														<div class="col-sm-4">
																																<input type="date" class="form-control" required placeholder="From" style="border-radius:3px;">
																														</div>
																														<label class="col-sm-2 col-form-label"><h6>To:*</h6></label>
																														<div class="col-sm-4">
																																<input type="date" class="form-control" required placeholder="To" style="border-radius:3px;">
																														</div>
																													</div>
																												</div>
																												...
																												<table class="table table-responsive table-bordered" rules="all" id="ContentPlaceHolder1_grd" style="width:100%;border-collapse:collapse;" cellspacing="0" cellpadding="4" border="1">
																													<tbody>
																														<tr style="color:White;background-color:#000000;font-weight:bold;" align="center">
																															<th scope="col" style="color:White;background-color:#000000;font-family:verdana;font-size:12px;" align="left">S No.</th>
																															<th scope="col" style="color:White;background-color:#000000;font-family:verdana;font-size:12px;" align="left">Name</th>
																															<th scope="col" style="color:White;background-color:#000000;font-family:verdana;font-size:12px;" align="left">City</th>
																															<th scope="col" style="color:White;background-color:#000000;font-family:verdana;font-size:12px;" align="left">Mobile</th>
																															<th scope="col" style="color:White;background-color:#000000;font-family:verdana;font-size:12px;" align="left">Amount</th>
																															<th scope="col" style="color:White;background-color:#000000;font-family:verdana;font-size:12px;" align="left">Credit/Debit</th>
																															<th scope="col" style="color:White;background-color:#000000;font-family:verdana;font-size:12px;" align="left">Narration</th>
																															<th scope="col" style="color:White;background-color:#000000;font-family:verdana;font-size:12px;" align="left">Franchisee</th>
																														...
																														<tr style="color:#333333;background-color:#F7F6F3;border-color:#8B91A0;" align="center">
																															...
																															<td>200</td>
																															<td>Cr.</td>
																															<td>Direct Income from GF100067</td>
																															<td>GF100012 </td>
																															<td>7/2/2021 3:15:44 PM </td>
																														</tr>
