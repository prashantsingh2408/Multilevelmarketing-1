                                                ...
                                                <div id="ContentPlaceHolder1_pnlContents" style="height: 100%; overflow: auto; background: #ffffe1 none repeat scroll 0 0">
                                                                        ...
                                                                        <tbody>
                                                                                    ...
                                                                                    <table width="100%">
                                                                                        <tbody>
                                                                                            <tr>
                                                                                                <td>
                                                                                                    <center>
                                                                                                        <img src="{{ asset('user_assets/img/logo.png') }}" height=" 120px ">
                                                                                                    </center>
                                                                                                </td>
                                                                                            </tr>
                                                                                            <tr>
                                                                                                <td align="center " style="font-size: 20px; font-weight: bold; font-family: Sans-Serif; ">
                                                                                                    CONGRATULATIONS
                                                                                                </td>
                                                                                            </tr>
                                                                                        </tbody>
                                                                            ...
                                                                            <tr>
                                                                                <td align="center " style="font-size: 16px;width:100%; ">
                                                                                    ...
                                                                                    financial
                                                                                    freedom.<br>
                                                                                    <span style="font-size: 13px "><b>Note:</b>
                                                                                        This
                                                                                        is
                                                                                        computer
                                                                                        generated
                                                    ...
                                                    <center style="padding:10px; ">
                                                        <button type="button " class="btn btn-success ">
                                                            ...
                                                            <!--  -->
                                                            <!-- Required Jquery -->
                                                            <script type="text/javascript " src="{{ asset('user_assets/js/jquery/jquery.min.js') }} ">
                                                            </script>
                                                            <script type="text/javascript " src="{{ asset('user_assets/js/jquery-ui/jquery-ui.min.js') }} ">
                                                            </script>
                                                            <script type="text/javascript " src="{{ asset('user_assets/js/popper.js/popper.min.js') }} ">
                                                            </script>
                                                            <script type="text/javascript " src="{{ asset('user_assets/js/bootstrap/js/bootstrap.min.js') }} ">
                                                            </script>
                                                            <!-- waves js -->
                                                            <script src="{{ asset('user_assets/pages/waves/js/waves.min.js') }} ">
                                                            </script>
                                                            <!-- jquery slimscroll js -->
                                                            <script type="text/javascript " src="{{ asset('user_assets/js/jquery-slimscroll/jquery.slimscroll.js') }} ">
                                                            </script>

                                                            <!-- slimscroll js -->
                                                            <script src="{{ asset('user_assets/js/jquery.mCustomScrollbar.concat.min.js') }} ">
                                                            </script>

                                                            <!-- menu js -->
                                                            <script src="{{ asset('user_assets/js/pcoded.min.js') }} ">
                                                            </script>
                                                            <script src="{{ asset('user_assets/js/vertical/vertical-layout.min.js') }} ">
                                                            </script>

                                                            <script type="text/javascript " src="{{ asset('user_assets/js/script.js') }} ">
                                                            </script>
