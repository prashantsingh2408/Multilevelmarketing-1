                        ...
                        <div class="card table-card">
                          ...
                          <div class="card-block">
                            <div class="form-group row" style="display:flex;justify-content:space-between;">
                              ...
                              <div class="col-xl-4 col-md-4 col-sm-6 text-center">
                                <button class="btn waves-effect waves-light btn-inverse" id="print" style="border-radius:5px;margin:5px;"><i class="fa fa-print" aria-hidden="true"></i>Print</button>
                              </div>
                              <div class="col-xl-4 col-md-4 col-sm-12 text-center">
                                <button class="btn waves-effect waves-light btn-inverse" style="border-radius:5px;margin:5px;">Add User By
                                  Agent</button>
                              </div>
                            </div>
                            ...
                            <div class="form-group row">
                              ...
                              <div class="col-xl-6 co-md-12 col-sm-12">
                                <div class="form-group row">
                                  ...
                                  <div class="col-sm-9">
                                    <input type="number" class="form-control" required placeholder="0000 000 000" style="border-radius:3px;">
                                  </div>
                                </div>
                              </div>
                            </div>
                            ...
                            <div class="form-group row">
                              <div class="col-xl-4 col-md-4 col-sm-6 text-center">
                                <button class="btn waves-effect waves-light btn-danger" style="border-radius:5px;margin:5px;"><i class="icofont icofont-check-circled"></i>Reset</button>
                              </div>
                              <div class="col-xl-4 col-md-4 col-sm-6 text-center">
                                <button class="btn waves-effect waves-light btn-success" style="border-radius:5px;margin:5px;"><i class="icofont icofont-check-circled"></i>Issue</button>
                              </div>
                              <div class="col-xl-4 col-md-4 col-sm-12 text-center">
                                <button class="btn waves-effect waves-light btn-inverse" style="border-radius:5px;margin:5px;">Block/Unblock
                                  Customer</button>
                              </div>
                            </div>
                              ...
                              <table class="table table-responsive table-bordered" rules="all" id="ContentPlaceHolder1_grd" style="width:100%;border-collapse:collapse;" cellspacing="0" cellpadding="4" border="1">
                                <tbody>
                                  <tr style="color:White;background-color:#000000;font-weight:bold;" align="center">
                                    ...
                                    <th scope="col" style="color:White;background-color:#000000;font-family:verdana;font-size:12px;" align="left">password</th>
                                    ...
                                    <th scope="col" style="color:White;background-color:#000000;font-family:verdana;font-size:12px;" align="left">Mobile No.</th>
                                    <th scope="col" style="color:White;background-color:#000000;font-family:verdana;font-size:12px;" align="left">Date of Joining</th>
                                    <th scope="col" style="color:White;background-color:#000000;font-family:verdana;font-size:12px;" align="left">Block/Unblock Member</th>
                                    <th scope="col">Activation Date</th>
                                    <th scope="col">Top Up</th>
                                    <th scope="col" style="color:White;background-color:#000000;font-family:verdana;font-size:12px;" align="left">Info..</th>
                                  ...
                                  <tr style="color:#333333;background-color:#F7F6F3;border-color:#8B91A0;" align="center">
                                    ...
                                    <td>
                                      <a target="_blank" href="editprofileadmin.aspx?id=GF100000">
                                        Edit</a>
                                    </td>
                                    ...
                                    <td></td>
                                    <td>
                                      <a href="TopupReport.aspx?id=GF100000">Topup
                                        Report</a>
                                    </td>
                                    <td style="font-size:12px;height:30px;" align="left">
                                      <a id="ContentPlaceHolder1_grd_Info_0" href="javascript:openWindow('1');">More
                                        Info..</a>
                                    </td>
                                    <td>
                                  ...
                                  <tr class="grd" style="color:#284775;background-color:White;border-color:#8B91A0;" align="center">
                                    ...
                                    <td>
                                      <a target="_blank" href="editprofileadmin.aspx?id=GF100001">
                                        Edit</a>
                                    </td>
                                    <td style="font-size:12px;height:30px;" align="left">
                                    ...
                                    <td>
                                      <a href="TopupReport.aspx?id=GF100001">Topup
                                        Report</a>
                                    </td>
                                    <td style="font-size:12px;height:30px;" align="left">
                                      <a id="ContentPlaceHolder1_grd_Info_1" href="javascript:openWindow('2');">More
                                        Info..</a>
                                    </td>
                                    <td>
                                      <a target="_blank" href="../Member_Login/Dashboard.aspx?adminTrack=GF100000">
