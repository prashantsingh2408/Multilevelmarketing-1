...
<head>
    <title>Golden Life Foundation</title>
      ...
      <!-- ico font -->
      <link rel="stylesheet" type="text/css" href="{{asset('user_assets/icon/icofont/css/icofont.css')}}">
      <!-- Font Awesome -->
      <link rel="stylesheet" type="text/css" href="{{asset('user_assets/icon/font-awesome/css/font-awesome.min.css')}}">
      <!-- Style.css -->
            ...
            <div class="row">
                <div class="col-sm-12">
                    <!-- Authentication card start -->
                        <form action="{{url('User/auth')}}" method="post" class="md-float-material form-material">
                            {{@csrf_field()}}
                            <div class="text-center">
                                <img src="{{asset('user_assets\img\logo.png')}}" alt="logo.png" class="main-img">
                            </div>
...
<script type="text/javascript" src="{{asset('user_assets/js/common-pages.js')}}"></script>
</body>
</html>
