                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-8">
                                        <div class="page-header-title">
                                            <h5 class="m-b-10">Paid Payment Report</h5>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <ul class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item"><a href="#">Paid Payment Report</a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                                    ...
                                                    <div class="card-block">
																											...
																											<div class="form-group row">
																												<div class="col-xl-8 co-md-12 col-sm-12">
																													<div class="form-group row">
																														<label class="col-sm-2 col-form-label"><h6>From Date:*</h6></label>
																														<div class="col-sm-4">
																																<input type="date" class="form-control" required placeholder="TrackID" style="border-radius:3px;">
																														</div>
																														<label class="col-sm-2 col-form-label"><h6>To Date:*</h6></label>
																														<div class="col-sm-4">
																																<input type="date" class="form-control" required placeholder="TrackID" style="border-radius:3px;">
																														</div>
																													</div>
