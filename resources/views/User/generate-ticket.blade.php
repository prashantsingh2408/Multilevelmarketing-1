                                                ...
                                                <div class="card table-card">
                                                    ...
                                                    <div class="card-block">
																											<div class="form-group row">
																													<label class="col-sm-2 col-form-label"><h6>Select Status*</h6></label>
																													<div class="col-sm-10">
																											...
																											<div class="form-group row">
																													<label class="col-sm-2 col-form-label"><h6>Subject*:</h6></label>
																													<div class="col-sm-10">
																															<textarea class="form-control" required placeholder="Enter Description"></textarea>
																													</div>
																											</div>
																											<div class="form-group row">
																													<label class="col-sm-2 col-form-label"><h6>Upload Image*:</h6></label>
																													<div class="col-sm-10">
